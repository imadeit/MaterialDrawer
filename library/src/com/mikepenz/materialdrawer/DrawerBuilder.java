...
public class DrawerBuilder {
    ...
    // list in drawer
    protected ArrayList<IDrawerItem> mDrawerItems = new ArrayList<IDrawerItem>();
    ...
    protected ArrayList<IDrawerItem> mStickyDrawerItems = new ArrayList<IDrawerItem>();
    ...
    public DrawerBuilder addStickyDrawerItems(IDrawerItem... stickyDrawerItems) {
        if (this.mStickyDrawerItems == null) {
            this.mStickyDrawerItems = new ArrayList<IDrawerItem>();
        }
